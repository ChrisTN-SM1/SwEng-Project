...
public class ListaIssueController implements Initializable {
    @FXML
    private TableView<Issue> listaIssueTable;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ObservableList<Issue> lista = FXCollections.observableArrayList(HTTPRequestManager.getListaIssue());
        ...
        listaIssueTable.setItems(lista);
    }
}
