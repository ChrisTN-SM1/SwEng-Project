...
public class ArchiveController implements Initializable {
    @FXML
    private TableView<Issue> archiveTableView;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        viewColumn.setCellFactory(issueBooleanTableColumn -> new ViewDetailCell(archiveTableView));

        archiveTableView.setItems(list);
    }
}
